...
For SAML and GitHub OAuth, see the [grafana-cloud/admin skill](https://github.com/grafana/skills/blob/05196628fa1a6a557fad1a5623156170693607eb/skills/grafana-cloud/admin/references/sso.md). The configs are the same in OSS.
