...
1. Click **Add visualization** to add your first panel
1. Select a data source, write a query, choose visualization type
1. Click **Apply** to save the panel to the dashboard
1. Click the save icon (or Ctrl+S) to save the dashboard
...
1. **Use variables**: Make dashboards reusable across environments/services
1. **Limit panels per dashboard**: Aim for \<20 panels for performance
1. **Use library panels**: Standardize common panels across teams
1. **Tag dashboards**: Consistent tags for searchability
1. **Version control**: Export JSON and store in Git
1. **Use rows**: Collapse related panels to organize complex dashboards
1. **Template your queries**: Use variables so one dashboard covers many targets
