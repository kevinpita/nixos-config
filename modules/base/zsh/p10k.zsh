# Generated by Powerlevel10k configuration wizard on 2024-08-22 at 13:39 CEST.
...
() {
  ...
  # Show used/total RAM instead of just free RAM.
  function prompt_ram() {
    ...
    used_gb=$(printf '%.1f' $(( used_mb / 1024.0 )))
    total_gb=$(printf '%.1f' $(( total_mb / 1024.0 )))
    p10k segment -f 66 -t "${used_gb}/${total_gb}GB"
  }
  # Custom icon.
  ...
  #############[ kubecontext: current kubernetes context (https://kubernetes.io/) ]#############
  # Always show kubecontext (kubie sets KUBECONFIG per-shell, so this reflects the active context).
  ...
  function prompt_cached_ip() {
    ...
    p10k segment -f $POWERLEVEL9K_IP_FOREGROUND -i '󰌗' -t "$P10K_IP_CACHE_TEXT"
  }
  # Custom icon.
